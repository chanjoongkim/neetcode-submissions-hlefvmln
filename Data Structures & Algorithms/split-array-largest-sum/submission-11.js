class Solution {
    ...
    splitArray(nums, k) {
        ...
        // use prefixSums to more easily get sum of subarray
    ...
    // greedily try to split array instead
    // more efficient than our recursive algorithm because this runs in O(N) time
    canSplit(nums, max, k) {
        let subArrays = 1;
        let currSum = 0;
