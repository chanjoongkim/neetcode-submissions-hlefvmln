class Solution {
    ...
    dfs(piles: number[], left: number, right: number, memo: Map<string, number>): number {
        ...
        // at each step, we take the largest gap between taking the pile at either end and the other player's turn
        // ultimately if the final number is positive, Alice won. Else Bob won.
