            ...
            if (stack.isEmpty()) {
                ...
                if (currHeight > stack.peek().height) {
                    ...
                    while (!stack.isEmpty() && currHeight <= stack.peek().height) {
                        oldTop = stack.pop();
                        // I don't need to do the first check below because it either gets covered at the end after we end the for loop
                        // or it gets checked by the next "pop" operation
