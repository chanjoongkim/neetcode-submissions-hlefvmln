...
class Solution {
    ...
    reverseKGroup(head, k) {
        ...
        while (true) {
            ...
            // console.log('cjk1', kthNode.val, prev.val, curr.val, oldHead.val, newHead.val);

            oldHead.next = nextNode;
            prev.next = newHead;
            prev = oldHead;
            curr = nextNode;
            // console.log('cjk2', kthNode.val, prev.val, curr.val, oldHead.val, newHead.val);
        }
