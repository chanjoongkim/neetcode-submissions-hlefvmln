class Solution {
    ...
    /**
     * BFS algorithm:
     * we start at the coast, and work our way "upward" to find all cells that can reach the given ocean
     * essentially working in reverse. We populate the reach matrix with all cells that can reach the given ocean
     */
