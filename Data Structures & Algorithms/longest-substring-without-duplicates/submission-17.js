    ...
    lengthOfLongestSubstring(s) {
        ...
        for (let i = 1; i < s.length; i++) {
            ...
            if (!charsIndexMap.has(char)) {
                ...
                // verify that the old index is to the right of our current left. Otherwise if it's an earlier index
                // then we don't need to reset left (since our current left is already past the old index)
